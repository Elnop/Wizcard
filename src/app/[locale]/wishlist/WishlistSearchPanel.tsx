...
/**
 * Card search panel wired for the wishlist page: left-click opens the card
 * modal, right-click shows the search-page context menu (add to
 * collection/wishlist/deck).
 */
export function WishlistSearchPanel({ expanded, onToggleExpand, onClose }: Props) {
	...
	return (
		<CardSearchPanel
			mode={{ kind: 'wishlist', onCardClick, buildCardMenuItems }}
			onClose={onClose}
			expanded={expanded}
